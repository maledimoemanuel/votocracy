...
// Create a new event
app.post('/create-event', verifyUser, (req, res) => {
  ...
  app.post('/add-participant', verifyUser, (req, res) => {
  ...
  // Update participant
  app.put('/update-participant/:participant_id', verifyUser, (req, res) => {
  ...
  // Delete participant
  app.delete('/delete-participant/:participant_id', verifyUser, (req, res) => {
    const { participant_id } = req.params;
...
app.get("/events", (req, res) => {
  ...
  // Delete event
  app.delete('/delete-event/:event_id', verifyUser, (req, res) => {
